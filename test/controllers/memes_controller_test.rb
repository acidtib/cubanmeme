...
class MemesControllerTest < ActionController::TestCase
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post :create, meme: { caption_one: @meme.caption_one, caption_two: @meme.caption_two, image: @meme.image, name: @meme.name }
    end
  ...
  test "should update meme" do
    patch :update, id: @meme, meme: { caption_one: @meme.caption_one, caption_two: @meme.caption_two, image: @meme.image, name: @meme.name }
    assert_redirected_to meme_path(assigns(:meme))
  end
